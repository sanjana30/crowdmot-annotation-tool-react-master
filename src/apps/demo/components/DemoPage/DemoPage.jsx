	...
	return (
		<div>
			...
			<div className="nav-wrapper">
                ...
                <Link to="/login" className="last-nav-link">Log In</Link>
			...
			<Form className="mb-2 col-xs-12 col-lg-10 offset-lg-1" onSubmit={this.handleSubmitAnnot}>
					<FormGroup>
			...
			<div className='mb-5'>
				...
				/>
				{/* {console.log(this.defaultAnnotations)} */}
			</div>
		</div>
